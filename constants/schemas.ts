...
export const organizationSchema = {
  ...
  "sameAs": [
    "https://www.linkedin.com/company/quicktalog"
  ],
  "address": {
    "@type": "PostalAddress",
    "addressCountry": "US"
...
export const websiteSchema = {
  ...
  "name": "Quicktalog",
  "url": "https://quicktalog.app",
  "description": "Create stunning digital catalogs in minutes with our free online catalog maker. Perfect for restaurants, salons, gyms, retail & more.",
  "publisher": {
    "@type": "Organization",
    "name": "Quicktalog",
    "logo": "https://quicktalog.app/logo.svg"
...
export const serviceSchema = {
  ...
  "description": "Professional digital catalog creation and management service for businesses. Create interactive, mobile-friendly catalogs with AI-powered tools, OCR import, and real-time analytics.",
  "provider": {
    "@type": "Organization",
    "name": "Quicktalog",
    "url": "https://quicktalog.app"
