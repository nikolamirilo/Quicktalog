...
const CatalogueHeader: React.FC<CatalogueHeaderProps> = ({ 
  ...
  return (
    <header className="border-b shadow-lg z-50" role="banner" aria-label={`${type === 'default' ? 'Quicktalog' : 'Company'} header navigation`} style={{
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between py-2 sm:py-3">
          ...
          <div className="flex items-center">
            <Link href="/" className="flex items-center space-x-2 group transition-transform duration-200 hover:scale-105" aria-label={`Go to ${type === 'default' ? 'Quicktalog' : 'company'} homepage`}>
              <Image
                src={logoPath}
          ...
          <nav className="flex items-center space-x-2 sm:space-x-4" role="navigation" aria-label="Contact and actions">
            {/* Contact Icons */}
            <div className="hidden sm:flex items-center space-x-2" role="group" aria-label="Contact options">
              <a 
              ...
              >
                <FiMail className="w-4 h-4 sm:w-5 sm:h-5 group-hover:scale-110 transition-transform duration-200" aria-hidden="true" />
              </a>
              {type === 'custom' && customPhone && (
                ...
                >
                  <FiPhone className="w-4 h-4 sm:w-5 sm:h-5 group-hover:scale-110 transition-transform duration-200" aria-hidden="true" />
                </a>
              )}
            </div>
