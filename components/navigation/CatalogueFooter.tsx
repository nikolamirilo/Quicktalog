      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-6">
          ...
          <div className="space-y-4">
            <Link
              href="/"
              className="flex items-center space-x-4 group transition-all duration-200 hover:scale-105">
              <Image
                src={logoPath}
            ...
            <div className="flex items-center space-x-3">
              {Object.keys(type === "default" ? socialLinks : customSocialLinks).map((platform) => (
                <Link
                  key={platform}
                  href={
                    (type === "default" ? socialLinks : customSocialLinks)[
              ...
              <div className="space-y-3">
                {customPartnerBadges.map((partner, index) => (
                  <div
                    ...
                    style={{ backgroundColor: "var(--card-bg)", color: "var(--card-description)" }}>
          ...
          {type === "default" && (
            <div className="space-y-4">{/* Empty column for alignment */}</div>
          )}
        </div>
