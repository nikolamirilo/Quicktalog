    ...
    <Body style={main}>
      <Container style={container}>
        ...
        <Section style={successSection}>
          <Text style={successTitle}>🎉 Congratulations, {userName}!</Text>
          <Text style={successText}>
            Your digital catalog <strong>"{catalogueName}"</strong> is now live and ready to share with your customers!
          </Text>
        </Section>
        ...
        {qrCodeUrl && (
          <Section style={qrSection}>
            ...
            <Text style={contentText}>
              Use this QR code to make your catalog easily accessible. Customers can simply scan it with their phone camera to view your catalog instantly.
            </Text>
            ...
            <Text style={qrNote}>
              Print this QR code on business cards, flyers, or display it in your store for easy access.
            </Text>
          </Section>
        )}
        ...
        <Section style={embedSection}>
          ...
          <Text style={codeNote}>
            Copy and paste this code into your website to embed your catalog as a full-screen overlay.
          </Text>
        </Section>
        ...
        {analyticsUrl && (
          <Section style={analyticsSection}>
            ...
            <Text style={contentText}>
              Monitor how your catalog is performing with detailed analytics. See how many people are viewing your catalog, which items are most popular, and more.
            </Text>
          ...
          <div style={tipsList}>
            ...
            <div style={tipItem}>
              ...
              <div style={tipContent}>
                ...
                <Text style={tipDescription}>
                  Check your analytics regularly to understand what your customers are most interested in.
                </Text>
              </div>
            </div>
          </div>
        ...
        <Section style={footer}>
          ...
          <div style={footerLinks}>
            <Link href="mailto:support@quicktalog.app" style={footerLink}>Contact Support</Link>
            <span style={footerSeparator}>•</span>
            <Link href="https://quicktalog.app/help" style={footerLink}>Help Center</Link>
            <span style={footerSeparator}>•</span>
