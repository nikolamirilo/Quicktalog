        ...
        <Container style={container}>
          ...
          <Section style={additionalSection}>
            ...
            <Text style={additionalText}>
              Click any rating above to open our feedback form where you can share more detailed thoughts, suggestions, or report any issues you encountered.
            </Text>
          ...
          <Section style={privacySection}>
            <Text style={privacyText}>
              <strong>Privacy:</strong> Your feedback is completely anonymous and will only be used to improve our platform. We never share personal information.
            </Text>
          </Section>
