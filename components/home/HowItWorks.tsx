...
const StepCard: React.FC<{ step: any, index: number }> = ({ step, index }) => {
    ...
    return (
        ...
        >
            ...
            <div
                className={clsx(
                    "group relative w-full h-full bg-white text-product-foreground rounded-xl border border-gray-200 transition-all duration-300 ease-out overflow-hidden",
                    {
                    ...
                    <div className="mt-3 space-y-2">
                        {step.features.map((feature: string, featureIndex: number) => (
                            <div key={featureIndex} className="flex items-start gap-2">
                                ...
                                <span className="text-xs text-product-foreground-accent font-lora">
                                    {feature}
                                </span>
                            </div>
                        ))}
    ...
    const steps = [
        {
            ...
            description: "First, let's get to know you. Add your business name, choose a theme that matches your brand, and set your currency. This is the foundation of your beautiful new catalog.",
            icon: <FiUpload className="w-8 h-8" />,
            image: "/layouts/layout_1.jpg", // Placeholder image
            features: [
        ...
        },
        {
            ...
            description: "Create categories to group your services or products. This makes it easy for your customers to find exactly what they're looking for.",
            icon: <TbCategory className="w-8 h-8" />,
            image: "/layouts/layout_2.jpg", // Placeholder image
            features: [
        ...
        },
        {
            ...
            description: "Now for the fun part! Add your services, products, or menu items. Include photos, descriptions, and prices to make them irresistible.",
            icon: <MdOutlineLocalOffer className="w-8 h-8" />,
            image: "/layouts/layout_3.jpg", // Placeholder image
            features: [
        ...
        },
        {
            ...
            description: "Add the finishing touches to make your catalog uniquely yours. Add your logo, customize your colors, and hit 'launch' to share it with the world.",
            icon: <IoDiamondOutline className="w-8 h-8" />,
            image: "/layouts/layout_4.jpg", // Placeholder image
            features: [
                "Upload your logo",
        ...
        },
        {
            ...
            description: "Your beautiful new catalog is ready! Share it with a link or QR code, and watch the customers roll in. Update it anytime, anywhere.",
            icon: <FiShare2 className="w-8 h-8" />,
            image: "/themes/light_1.jpg", // Placeholder image
            features: [
        ...
        },
        {
            ...
            description: "Feeling lazy? Just describe your business and our AI will create a beautiful, professional catalog for you in seconds. It's like magic!",
            icon: <FiZap className="w-8 h-8" />,
            image: "/themes/light_2.jpg", // Placeholder image
            features: [
            ...
            <div className="relative w-full">
                <div className="w-screen relative left-1/2 -translate-x-1/2">
                    <Swiper
                        ...
                        className="mt-4"
                        style={{
                            paddingLeft: 'max(20px, calc((100vw - 1280px) / 2 + 20px))', // Align first card with container
                            paddingRight: '0px', // Extend to right edge
                            paddingTop: '8px',
                            paddingBottom: '16px'
                        }}
                    >
