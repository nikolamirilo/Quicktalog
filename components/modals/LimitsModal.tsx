      ...
      <div className="bg-product-background rounded-lg shadow-lg max-w-md w-full mx-4 overflow-hidden">
        ...
        <div className="relative p-6 text-center bg-hero-product-background">
          ...
          <div className="flex justify-center mb-4">
            <div className="w-16 h-16 rounded-full flex items-center justify-center bg-product-primary">
              {isTraffic ? (
                <Zap className="w-8 h-8 text-product-secondary" />
              ) : (
          ...
          <h2 className="text-xl font-semibold mb-2 text-product-foreground">
        ...
        <div className="p-6">
          {isTraffic ? (
            <>
              {/* Traffic Promo */}
              <div className="p-4 rounded-lg bg-product-hover-background mb-6">
            ...
            <>
              ...
              <div className="flex items-center justify-between my-6 p-3 rounded-lg bg-product-hover-background">
