...
export const metadata = {
  ...
  description: "The page you're looking for doesn't exist. Return to our homepage to create your digital catalog.",
}
    ...
    <div className="min-h-screen bg-gradient-to-br from-product-background to-hero-product-background flex items-center justify-center p-4">
      ...
      <div className="relative z-10 max-w-2xl mx-auto text-center">
        ...
        <div className="bg-product-background/95 backdrop-blur-sm border border-product-border rounded-3xl shadow-md p-8 sm:p-12 lg:p-16">
          ...
          {/* 404 Number */}
          <div className="mb-8">
            <h1 className="text-8xl sm:text-9xl lg:text-[12rem] font-bold text-product-primary/20 font-heading leading-none">
              404
            </h1>
          </div>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            ...
            <Button asChild variant="outline" className="w-full sm:w-auto border-2 border-product-primary">
