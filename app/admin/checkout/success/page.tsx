...
const page = () => {
  return (
    <div className="flex items-center justify-center min-h-screen bg-gradient-to-b from-gray-50 to-gray-100">
      <div className="w-full max-w-2xl py-12 px-6 mx-4 text-center transition-all transform bg-white shadow-lg rounded-xl hover:shadow-xl">
        <div className="flex items-center justify-center w-24 h-24 mx-auto mb-8 bg-orange-50 rounded-full">
          <svg
            className="w-12 h-12 text-product-primary"
            fill="none"
            stroke="currentColor"
            viewBox="0 0 24 24">
            <path
        ...
        <h1 className="mb-6 text-4xl font-extrabold text-product-primary">Payment Successful!</h1>
